...
The [integration tests](https://github.com/sclevine/agouti/blob/master/internal/integration/integration_test.go) are a great place to see everything in action and get started quickly!
