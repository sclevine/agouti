...
func BeSelected() types.GomegaMatcher {
	return &selection.BooleanMatcher{Method: "Selected", State: "selected"}
}
...
func BeVisible() types.GomegaMatcher {
	return &selection.BooleanMatcher{Method: "Visible", State: "visible"}
}
...
func BeEnabled() types.GomegaMatcher {
	return &selection.BooleanMatcher{Method: "Enabled", State: "enabled"}
}

// BeActive passes when the selection refers to the active page element.
func BeActive() types.GomegaMatcher {
	return &selection.BooleanMatcher{Method: "Active", State: "active"}
}
