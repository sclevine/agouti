...
func HaveText(text string) types.GomegaMatcher {
	return &ValueMatcher{Method: "Text", Property: "text", Expected: text}
}
...
func MatchText(regexp string) types.GomegaMatcher {
	return &MatchTextMatcher{Regexp: regexp}
}
...
func HaveCount(count int) types.GomegaMatcher {
	return &ValueMatcher{Method: "Count", Property: "element count", Expected: count}
}
...
func HaveAttribute(attribute string, value string) types.GomegaMatcher {
	return &HaveAttributeMatcher{ExpectedAttribute: attribute, ExpectedValue: value}
}
...
func HaveCSS(property string, value string) types.GomegaMatcher {
	return &HaveCSSMatcher{ExpectedProperty: property, ExpectedValue: value}
}
...
func BeSelected() types.GomegaMatcher {
	return &BooleanMatcher{Method: "Selected", Property: "selected"}
}
...
func BeVisible() types.GomegaMatcher {
	return &BooleanMatcher{Method: "Visible", Property: "visible"}
}
...
func EqualElement(comparable interface{}) types.GomegaMatcher {
	return &EqualElementMatcher{ExpectedSelection: comparable}
}
